...
@section('title', `4p's Student`)

@section('content')
<h1 class="mt-4">Scholar Students List</h1>
<ol class="breadcrumb mb-4">
    <li class="breadcrumb-item active">Scholar Students List</li>
</ol>
@if (session('success'))
...
<div class="row justify-content-end align-items-center mb-3">
    ...
    <div class="col-sm-auto">
        <a id="printButton" href="{{ route('admin.scholar-student.print') }}" target="_blank"
...
<script>
    $(document).ready(function() {
        ...
        const table = $('#dataTables').DataTable({
            ...
            scrollX: true,
            ajax: {
                url: "{{ route('admin.students.scholardisplay') }}",
                type: "GET",
            },
            columns: [{
                    data: 'DT_RowIndex',
            ...
            language: {
                search: "_INPUT_",
                searchPlaceholder: "Search Scholar students..."
            }
        });
    ...
    document.getElementById('pdfDownload').addEventListener('click', function() {
        ...
        if (schoolYearId) {
            window.location.href = "{{ route('admin.export.Scholarpdf') }}?school_year_id=" + schoolYearId;
        } else {
    ...
    document.getElementById('printButton').addEventListener('click', function(event) {
        ...
        var schoolYearId = document.getElementById('school_year_id').value;
        if (schoolYearId) {
            window.open("{{ route('admin.scholar-student.print') }}?school_year_id=" + schoolYearId);
        } else {
            alert("Please select a school year.");
        }
    });
