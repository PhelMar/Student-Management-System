...
<div class="row justify-content-end align-items-center mb-3">
    <div class="col-sm-auto">
        <a href="#" 
            ...
            data-route="{{ route('admin.solo-parent-student.print') }}"
            data-bs-toggle="modal" 
            data-bs-target="#reportModal">
            <i class="fas fa-file-alt me-2"></i>Generate Solo Parent Report
        </a>
    </div>
</div>
  ...
  <form id="reportForm" method="GET" target="_self">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="reportModalLabel">Generate Solo Parent Report</h5>
...
<script>
    $(document).ready(function() {
        ...
        const table = $('#dataTables').DataTable({
            ...
            scrollX: true,
            ajax: {
                url: "{{ route('admin.students.soloparentdisplay') }}",
                type: "GET",
            },
            columns: [{
                    data: 'DT_RowIndex',
