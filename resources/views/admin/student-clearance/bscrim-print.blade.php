...
<body>
    ...
    <table border="1">
        ...
        <tbody>
            ...
            @endforeach
            <tr>
                <td colspan="5" class="total">Total of cleared clearance in BSCRIM Department</td>
                <td class="total">{{ $BSCRIM->count() }}</td>
            </tr>
        </tbody>
    </table>
    <script>
