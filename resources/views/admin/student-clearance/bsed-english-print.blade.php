...
<head>
    ...
    <title>BSED ENGLISH PRINT</title>
...
<body>
    <div class="header">
        ...
        <div>
            ...
            <p>BSED ENGLISH Cleared Student Clearance List</p>
        </div>
    </div>
    <table border="1">
        <thead>
        ...
        <tbody>
            @foreach ($BSED_ENGLISH as $student)
            <tr>
            ...
            @endforeach
            <tr>
                <td colspan="5" class="total">Total of cleared clearance in BSED ENGLISH Department</td>
                <td class="total">{{ $BSED_ENGLISH->count() }}</td>
            </tr>
        </tbody>
    </table>
    <script>
