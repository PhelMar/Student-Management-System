...
<body>
    ...
    <table border="1">
        ...
        <tbody>
            ...
            @endforeach
            <tr>
                <td colspan="5" class="total">Total of cleared clearance in BSBA FM Department</td>
                <td class="total">{{ $BSBA_FM->count() }}</td>
            </tr>
        </tbody>
    </table>
    <script>
