...
<body>
    <div class="header">
        ...
        <div>
            ...
            <p>BSIT Cleared Student Clearance List</p>
        </div>
    </div>
    <table border="1">
        <thead>
        ...
        <tbody>
            ...
            @endforeach
            <tr>
                <td colspan="5" class="total">Total of cleared clearance in BSIT Department</td>
                <td class="total">{{ $BSIT->count() }}</td>
            </tr>
        </tbody>
    </table>
    <script>
