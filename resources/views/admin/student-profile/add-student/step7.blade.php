    ...
    <div class="col-xl-6 col-md-6">
        ...
        <div class="mb-4">
            ...
            <input type="text" class="form-control @error('elementary') is-invalid @enderror"
                name="elementary" value="{{ old('elementary') }}" required>
        ...
        <div class="mb-4">
            ...
            <input type="text" class="form-control @error('junior_high') is-invalid @enderror"
                name="junior_high" value="{{ old('junior_high') }}" required>
            <small class="error-message text-danger"></small>
        </div>
        <div class="mb-4">
    ...
    <div class="col-xl-6 col-md-6">
        ...
        <div class="mb-4">
            ...
            <input type="text" class="form-control @error('elementary_year_attended') is-invalid @enderror"
                name="elementary_year_attended" value="{{ old('elementary_year_attended') }}" required>
            <small class="error-message text-danger"></small>
        </div>
        <div class="mb-4">
            ...
            <input type="text" class="form-control @error('junior_high_year_attended') is-invalid @enderror"
                name="junior_high_year_attended" value="{{ old('junior_high_year_attended') }}" required>
            <small class="error-message text-danger"></small>
        </div>
        <div class="mb-4">
