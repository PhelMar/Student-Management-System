    ...
    <div class="col-xl-4 col-md-4">
        <div class="mb-4">
            ...
            <input type="text" class="form-control @error('contact_no') is-invalid @enderror" name="contact_no"
                value="{{ old('contact_no', $students->contact_no) }}" id="contact_no" required>
    ...
    <small class="error-message text-danger"></small>
        ...
        <div class="mb-4">
            ...
            <select class="form-control @error('solo_parent') is-invalid @enderror" required id="solo_parent"
                ...
                <option value="Yes" {{old('solo_parent', $students->solo_parent) == "Yes" ? 'selected' : ''}}>Yes
                </option>
            </select>
            <small class="error-message text-danger"></small>
        </div>
        <div class="mb-4">
            ...
            <select class="form-control @error('four_ps') is-invalid @enderror" required id="four_ps" name="four_ps">
                <option value="" disabled selected>Select</option>
                <option value="No" {{old('four_ps', $students->four_ps) == "No" ? 'selected' : ''}}>No</option>
                <option value="Yes" {{old('four_ps', $students->four_ps) == "Yes" ? 'selected' : ''}}>Yes</option>
            </select>
            <small class="error-message text-danger"></small>
        </div>
    </div>
    <div class="col-xl-6 col-md-6">
        <div class="mb-4">
            ...
            <select class="form-control @error('student_religion_id') is-invalid @enderror" name="student_religion_id"
                ...
                <option value="{{$religion->id}}"
                    {{$students->StudentsReligion && $students->StudentsReligion->id == $religion->id ? 'selected' : ''}}>
        ...
        <div class="mb-4" id="ips_remarks" style="display: none;">
            ...
            <input type="text" class="form-control @error('ips_remarks') is-invalid @enderror"
                value="{{old('ips_remarks', $students->ips_remarks)}}" required id="ips_remarksInput"
                name="ips_remarks">
            <small class="error-message text-danger"></small>
        </div>
        <div class="mb-4">
