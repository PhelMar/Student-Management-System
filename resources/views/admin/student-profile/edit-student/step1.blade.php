...
<div class="row">
    <div class="col-xl-6 col-md-6">
        <div class="mb-4">
            ...
            <input type="text" class="form-control @error('first_name') is-invalid @enderror"
                name="first_name" value="{{ old('first_name', $students->first_name) }}" required>
            <small class="error-message text-danger"></small>
        </div>
        <div class="mb-4">
            <label for="last_name" class="form-label" style="font-weight: bold;">Last Name</label>
            <input type="text" class="form-control @error('last_name') is-invalid @enderror"
                name="last_name" value="{{ old('last_name', $students->last_name)}}" required>
            <small class="error-message text-danger"></small>
        </div>
    </div>
    <div class="col-xl-6 col-md-6">
    ...
    <div class="col-xl-3 col-md-3">
        <div class="mb-4">
            ...
            <input type="text" class="form-control @error('birth_order_among_sibling') is-invalid @enderror" required
    ...
    <div class="col-xl-3 col-md-3">
        <div class="mb-4">
            ...
            <textarea type="text" class="form-control @error('place_of_birth') is-invalid @enderror"
                name="place_of_birth" rows="3" required>{{ old('place_of_birth', $students->place_of_birth) }}</textarea>
            <small class="error-message text-danger"></small>
        </div>
    </div>
    <hr style="border: 2px solid;stroke: black;" />
        ...
        <div class="mb-4">
            ...
            <select id="current_province" name="current_province_id" class="form-control @error('current_province_id') is-invalid @enderror" required>
                ...
                <option value="{{ $province->prov_code }}"
                    {{ $students->current_province_id == $province->prov_code ? 'selected' : '' }}>
                    {{ $province->prov_desc }}
                </option>
                @endforeach
            </select>
    ...
    <div class="col-xl-3 col-md-3">
        <div class="mb-4">
            ...
            <input type="text" class="form-control @error('current_purok') is-invalid @enderror"
                name="current_purok" id="current_purok" value="{{ old('current_purok', $students->current_purok) }}" required>
            <small class="error-message text-danger"></small>
        </div>
    </div>
    <hr style="border: 2px solid;stroke: black;" />
    ...
    <div class="col-xl-3 col-md-3">
        <div class="mb-4">
            ...
            <select id="permanent_province" name="permanent_province_id" class="form-control @error('permanent_province_id') is-invalid @enderror" required>
                ...
                @foreach ($provinces as $province)
                <option value="{{ $province->prov_code }}"
                    {{ $students->permanent_province_id == $province->prov_code ? 'selected' : '' }}>
                    {{ $province->prov_desc }}
                </option>
                @endforeach
            </select>
    ...
    <div class="col-xl-3 col-md-3">
        <div class="mb-4">
            ...
            <input type="text" class="form-control @error('permanent_purok') is-invalid @enderror"
                name="permanent_purok" value="{{ old('permanent_purok', $students->permanent_purok) }}" required>
            <small class="error-message text-danger"></small>
        </div>
    </div>
</div>