...
<body>
    <div class="header">
        ...
        <div>
            ...
            <p>BSBA MM Cleared Student Clearance List</p>
        </div>
    </div>
    <table border="1">
        <thead>
        ...
        <tbody>
            ...
            @endforeach
            <tr>
                <td colspan="5" class="total">Total of cleared clearance in BSBA MM Department</td>
                <td class="total">{{ $BSBA_MM->count() }}</td>
            </tr>
        </tbody>
    </table>
    <script>
