...
<head>
    ...
    <title>BSED SOCIAL STUDIES PRINT</title>
...
<body>
    <div class="header">
        ...
        <div>
            ...
            <p>BSED SOCIAL STUDIES Cleared Student Clearance List</p>
        </div>
    </div>
    <table border="1">
        <thead>
        ...
        <tbody>
            @foreach ($BSED_SOCIAL_STUDIES as $student)
            <tr>
            ...
            @endforeach
            <tr>
                <td colspan="5" class="total">Total of cleared clearance in BSED SOCIAL STUDIES Department</td>
                <td class="total">{{ $BSED_SOCIAL_STUDIES->count() }}</td>
            </tr>
        </tbody>
    </table>
    <script>
