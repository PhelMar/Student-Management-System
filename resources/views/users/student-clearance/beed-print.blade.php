...
<body>
    <div class="header">
        ...
        <div>
            ...
            <p>BEED Cleared Student Clearance List</p>
        </div>
    </div>
    <table border="1">
        <thead>
        ...
        <tbody>
            ...
            @endforeach
            <tr>
                <td colspan="5" class="total">Total of cleared clearance in BEED Department</td>
                <td class="total">{{ $BEED->count() }}</td>
            </tr>
        </tbody>
    </table>
    <script>
