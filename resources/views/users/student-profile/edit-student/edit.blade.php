...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('user.students.update',  Hashids::encode($students->id)) }}" method="post" id="updateStudentForm">
            @csrf
            @method('PUT')
            <div class="step" data-step="1">
                @include('users.student-profile.edit-student.step1')
                <button type="button" class="btn btn-primary next">Next</button>
            </div>
            <div class="step" data-step="2">
                @include('users.student-profile.edit-student.step2')
                <button type="button" class="btn btn-secondary back">Back</button>
                <button type="button" class="btn btn-primary next">Next</button>
            </div>
            <div class="step" data-step="3">
                @include('users.student-profile.edit-student.step3')
                <button type="button" class="btn btn-secondary back">Back</button>
                <button type="button" class="btn btn-primary next">Next</button>
            </div>
            <div class="step" data-step="4">
                @include('users.student-profile.edit-student.step4')
                <button type="button" class="btn btn-secondary back">Back</button>
                <button type="button" class="btn btn-primary next">Next</button>
            </div>
            <div class="step" data-step="5">
                @include('users.student-profile.edit-student.step5')
                <button type="button" class="btn btn-secondary back">Back</button>
                <button type="button" class="btn btn-primary next">Next</button>
            </div>
            <div class="step" data-step="6">
                @include('users.student-profile.edit-student.step6')
                <button type="button" class="btn btn-secondary back">Back</button>
                <button type="button" class="btn btn-primary next">Next</button>
            </div>
            <div class="step" data-step="7">
                @include('users.student-profile.edit-student.step7')
                <button type="button" class="btn btn-secondary back">Back</button>
...
<script>
    const checkEmailUrl = "{{ route('user.students.checkEmail') }}";
    const csrfToken = '{{ csrf_token() }}';

    const checkIDNoUrl = "{{ route('user.students.checkIDNo') }}";

    const municipalitiesUrl = "{{ route('user.municipalities', ':province_id') }}";
    const barangaysUrl = "{{ route('user.barangays', ':municipality_id') }}";
...
<script src="{{asset('user/js/editFunction.js')}}"></script>
@endsection