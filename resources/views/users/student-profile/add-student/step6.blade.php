    ...
    <div class="col-xl-6 col-md-6">
        <div class="mb-4">
            ...
            <select class="form-control @error('income_id') is-invalid @enderror"
                name="income_id" value="{{ old('income_id') }}" required>
    ...
    <div class="col-xl-6 col-md-6">
        <div class="mb-4">
            ...
            <input type="text" class="form-control @error('incase_of_emergency_name') is-invalid @enderror"
                name="incase_of_emergency_name" value="{{ old('incase_of_emergency_name') }}" required>
                <small class="error-message text-danger"></small>
        </div>
    </div>
    <div class="col-xl-6 col-md-6">
        <div class="mb-4">
            ...
            <input type="text" class="form-control @error('incase_of_emergency_contact') is-invalid @enderror"
                name="incase_of_emergency_contact" value="{{ old('incase_of_emergency_contact') }}" id="incase_of_emergency_contact" required>
