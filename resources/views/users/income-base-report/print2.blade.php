...
<body>
    <div class="header">
        ...
        <div>
            ...
            <p>Between 10K-20K Income Reports</p>
        </div>
    </div>
    <table border="1">
        <thead>
        ...
        <tbody>
            @foreach ($tenkToTwentyk as $student)
            <tr>
            ...
            @endforeach
            <tr>
                <td colspan="4" class="total">Total Income between 10k-20k </td>
                <td class="total">{{ $tenkToTwentyk->count() }}</td>
            </tr>
        </tbody>
    </table>
    <script>
