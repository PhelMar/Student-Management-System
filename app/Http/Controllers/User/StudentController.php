...
class StudentController extends Controller
{
    ...
    public function ipsDisplay()
    {
        ...
        return view('users.ips-student.display', compact('ipsData', 'school_years'));
    }
    ...
    public function pwdDisplay()
    {
        ...
        return view('users.pwd-student.display', compact('pwdData', 'school_years'));
    }
    ...
    public function soloparentDisplay()
    {
        ...
        return view('users.solo-parent-student.display', compact('soloparentData', 'school_years'));
    }
    ...
    public function incomeFirstDisplay()
    {
        ...
        return view('users.income-base-report.firstDisplay', compact('below10k', 'tenkToTwentyk', 'twentykToThirtyk', 'above30k'));
    }
