document.getElementById('printButton8').addEventListener('click', function () {
    const printWindow = window.open('', '', 'width=800,height=600');
    const tableContent = document.querySelector('#datatablesSimple8').outerHTML;

    const rows = document.querySelectorAll('#datatablesSimple8 tbody tr');
