document.getElementById('printButton7').addEventListener('click', function () {
    const printWindow = window.open('', '', 'width=800,height=600');
    const tableContent = document.querySelector('#datatablesSimple7').outerHTML;

    const rows = document.querySelectorAll('#datatablesSimple7 tbody tr');
        ...
        <body>
            <div class="header">
                ...
                <div>
                    ...
                    <p>BSED VALUES Cleared Student Clearance List</p>
                </div>
            </div>
            ${tableContent}
            <table>
