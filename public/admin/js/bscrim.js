document.getElementById('printButton9').addEventListener('click', function () {
    const printWindow = window.open('', '', 'width=800,height=600');
    const tableContent = document.querySelector('#datatablesSimple9').outerHTML;

    // Calculate total students based on number of rows
    const rows = document.querySelectorAll('#datatablesSimple9 tbody tr');
        ...
        <body>
            <div class="header">
                ...
                <div>
                    ...
                    <p>BSCRIM Cleared Student Clearance List</p>
                </div>
            </div>
            ${tableContent}
            <table>
