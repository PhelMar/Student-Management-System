document.getElementById('printButton2').addEventListener('click', function () {
    ...
    const tableContent = document.querySelector('#datatablesSimple2').outerHTML;

    // Calculate total students based on number of rows
    const rows = document.querySelectorAll('#datatablesSimple2 tbody tr');
        ...
        <body>
            <div class="header">
                ...
                <div>
                    ...
                    <p>BSTM Cleared Student Clearance List</p>
                </div>
            </div>
            ${tableContent}
            <table>
